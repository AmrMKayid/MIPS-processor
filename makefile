...
SRCS = DataMemory.v Mux2way1.v Mux2way32.v Mux4way1.v Mux4way32.v SignExtend.v ControlUnit.v Adder.v InstructionMemory.v ProgramCounter.v RegisterFile.v shiftLeft2.v ALU.v ALUControl.v Processor.v
